...
urlpatterns = [
    ...
    path('transactions/', main_views.TransactionsListDelete.as_view(), name='transactions', kwargs={'account':None}),
    path('transactions/<int:account>/', main_views.TransactionsListDelete.as_view(), name='transactions'),
